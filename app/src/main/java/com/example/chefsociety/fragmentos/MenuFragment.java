...
public class MenuFragment extends Fragment {
    ...
    private final int[] BOTONES_MENU={R.id.ib_men_catalogo,R.id.ib_men_recetas,R.id.ib_men_favoritos,R.id.ib_men_opciones};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // para instanciar la parte logica con la parte grafica
